...
export default class Signaling extends events.EventEmitter {
    ...
    return new Promise((pResolve, pReject) => {
      ...
      navigator.mediaDevices.enumerateDevices()
        .then(devices => {
          ...
          //     video: {
          //       mandatory: {
          //         sourceId: videoDevices[cameraFacing],
          //         minWidth: 200,
          //         maxWidth: 800,
          //         minAspectRatio: 1.6
          //       },
        ...
        .then(function (constraints) {
          navigator.mediaDevices.getUserMedia(constraints)
            .then(function (mediaStream) {
              ...
              alert("Please check your camera: " + err.message);
              pReject(err);
            }
            );
        })
  ...
  createPeerConnection = (id, media, isOffer, localstream) => {
    ...
    pc.ontrack = (event) => {
      ...
      this.emit('addstream', event.streams[0], event.track);
    }
    ...
    localstream.getTracks().forEach((track) => { console.log('foreachtrack', track); pc.addTrack(track, localstream) });
