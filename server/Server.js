...
export default class CallHandler {
    ...
    updatePeers = () => {
        ...
        this.clients.forEach(function (client) {
            ...
            if (client.hasOwnProperty('parent_url')) {
                peer.parent_url = client.parent_url;
            }
            if (client.hasOwnProperty('iframe_url')) {
                peer.iframe_url = client.iframe_url;
            }
            peers.push(peer);
        });
                ...
                case 'new':
                    {
                        ...
                        client_self.parent_url = message.parent_url;
                        client_self.iframe_url = message.iframe_url;
                        this.updatePeers();
                    }
                    break;
                case 'bye':
